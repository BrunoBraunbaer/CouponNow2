...
public class sell extends Activity {
    ...
    public void init0(){
        ...
        MainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent MainActivity = new Intent(sell.this, MainActivity.class);
    ...
    public void init1(){
        ...
        mySite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mySite = new Intent(sell.this, mySite.class);
    ...
    public void init2(){
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent search = new Intent(sell.this, search.class);
    ...
    public void init3() {
        ...
        alert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent alert = new Intent(sell.this, alert.class);
                startActivity(alert);
            }
        });
    }
    ...
    public void init4() {
        ...
        sell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent sell = new Intent(sell.this, sell.class);
                startActivity(sell);
            }
        });
